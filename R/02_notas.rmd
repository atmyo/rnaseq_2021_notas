...
Summarize experiment es un objeto cuya parte principal consiste de tres partes unidas. 
    - rowRanges → tabla de información de los genes, un renglon por cada gen. Es un 
                objeto tipo genomic ranges.
    - Assays → contiene los datos [genes, muestras]. Puede ser una matriz o más.
    - colData → un renglón por cada muestra, una columna por cada variable.
